...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['delete_order'])) {
    ...
    if (mysqli_query($conn, $delete_order_query)) {
        ...
        header("Location: dashboard.php?message=Error deleting order: " . mysqli_error($conn) . "&alert=danger");
        exit();
    }
} else {
    header("Location: dashboard.php?message=Invalid request&alert=danger");
    exit();
}
